...
<body>
    ...
    <div>
        <center><h2>Cantidad de Revistas y Memorias por Bimestre</h2></center>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var datosGrafica = {!! json_encode($serviciosPorBimestreRevistaMemoria) !!};
            ...
            var proyectosChart = new Chart(proyectosCanvas, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Cantidad de Revistas y Memorias',
