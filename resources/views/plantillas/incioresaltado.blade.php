...
<div class="container">
    ...
    @if(request()->routeIs(['iniciousuario', 'dashboardauser','loginuser'])) <!-- Reemplaza 'nombre_de_la_ruta_de_iniciousuario' con la ruta real -->
    ...
    <!-- Formulario oculto -->
    <form action="{{route('editarfecha2', 1)}}" method="POST" id="myForm">
        @csrf
        @method('PUT')
        ...
        <div class="row" style="background-color: #eee5e54d; padding: 20px; border-radius:.5rem">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" id="bimestre" name="bimestre" style="font-size: small;">
...
{{-- Barra de navegacion lateral principio --}}
    ...
    <div class="sidebar">
        ...
        <ul class="nav_list">
            <li class="active-section @if(request()->is('iniciousuario')) active-section @else '' @endif">
