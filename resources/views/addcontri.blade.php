...
@section('contenido') 
<title>Nueva Contribución</title>
        <h3 class="fw-bold text-center py-5">Nueva Contribución</h3>
        {{--Inicio del Login o Acceso --}}
            <form action="addcontribu" method="POST">
            ...
            <div>
                <a href="contri" class=" btn btn-danger" tabindex="4" id="redondb">
