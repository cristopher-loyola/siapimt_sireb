...
// Hoja 1 Inicio
    // Inicio del Header de la hoja de inicio
        ...
        $table->addRow(50);
        $table->addCell(null, $cellRowContinue);
        $table->addCell(8000, $styleTable1)->addText('AUTORIZACIÓN CANCELACIÓN DE PROYECTO',
                'encabezado1',
                array(
                    'alignment' => \PhpOffice\PhpWord\SimpleType\Jc::CENTER,
                ));
    ...
    // Inicio de contenido de hoja 1
        ...
        $section1->addTextBreak(1);
        $section1->addText(htmlspecialchars('Se determina viable la Cancelación del Proyecto '.$nombreproyecto), 'letrastablas');
        $section1->addTextBreak(1);
...
$file = 'Autorización Cancelación-'.$nombreproyecto.'.docx';
