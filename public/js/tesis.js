...
$('.button').click(function(){
  ...
  $(document).on("click", "#btnedit",function(){
    ...
    var nombrealumno = $(this).data('nombrealumno');
    var nombreespecialidad = $(this).data('nombreespecialidad');
    ...
    var fasetesis = $(this).data('fasetesis');
    ...
    $('#participacionedit').val(participacion);
    $('#nombre_estudianteedit').val(nombrealumno);
    $('#nombreespecialidadedit').val(nombreespecialidad);
    $('#facultadedit').val(facultad);
    $('#nombretesisedit').val(titulotesis);
    $('#estadoedit').val(fasetesis);
    $('#estudianteedit').val(estudiante);
  ...
  $(document).on("click", "#btnviz",function(){
    ...
    // Llenar los campos del formulario modal con los datos de la fila
        ...
        $('#institucionviz').text(institucion);
        $('#participacionviz').text(participacion);
        $('#nombre_estudianteviz').text(nombrealumno);
        $('#nombreespecialidadviz').text(nombreespecialidad);
        $('#facultadviz').text(facultad);
        $('#nombretesisviz').text(titulotesis);
        $('#fasetesisviz').text(fasetesis);
        $('#gradoviz').text(grado);
        $('#encargadoservicioviz').text(encargadoservicio);
        $('#estudianteviz').text(estudiante);
