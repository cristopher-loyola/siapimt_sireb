...
$('.button').click(function(){
  ...
  $(document).on("click", "#btnedit",function(){
    ...
    var nombreactividad = $(this).data('nombreactividad');
    ...
    $('#actividadedit').val(nombreactividad);
    $('#fechaedit').val(fecha);
    $('#tipoactividadedit').val(tipoactividad);
    $('#descripcionedit').val(descripcion);
    $('#nombre_personaedit').val(nombrepersona);
...
removeSelectedButtonedit.addEventListener("click", function () {
  ...
  $(document).on("click", "#btnviz",function(){
    ...
    // Llenar los campos del formulario modal con los datos de la fila
    $('#actividadviz').text(nombreactividad);
    $('#fechaviz').text(fecha);
