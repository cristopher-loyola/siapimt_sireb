...
<p>Buen día {{ $details['participante']->Nombre }}, se le notifica que {{ $details['servicio']->username }} lo ha agregado en el Sistema de Reportes Bimestrales, como participante de:</p>
<br>
