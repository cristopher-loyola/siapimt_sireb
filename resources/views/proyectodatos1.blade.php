...
<head>
    ...
    <style>
        *{
        ...
        body {
            margin: 0;
            padding: 0 0 0 150px; /* Espacio para el sidebar */
        }
        header{
            display: flex;
        ...
        /* Estilos responsivos para Quill */
        .ql-editor-container {
            width: 100%;
            max-width: 800px;
            margin: 0 auto;
            ...
            <div class="form-group">
                @php
                    ...
                    if($proyt->clavet == 'I'){
                        ...
                        $placeholder = 'Justificar la realización de la investigación, refiriéndose a la solicuitud de una Unidad Administrativa de la SICT o de un cliente externo.';
                    }
                @endphp
                ...
                <div class="ql-editor-container">
                    <div class="editor-quill" data-input="justificacion"
                        ...
                        @endif>
                        @if(!empty(strip_tags($justificacion))){!!$justificacion !!}@endif
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="ql-editor-container">
                    <div class="editor-quill" data-input="antecedente"
                        ...
                        @endif>
                        @if(!empty(strip_tags($antecedente))){!!$antecedente!!}@endif
                    </div>
                </div>
