...
@for ($i = 1; $i <= 6; $i++)
    @if (!empty($serviciosRevistasMemorasNGET[$i]))
        ...
        <table>
            ...
            <tbody>
                @foreach($serviciosRevistasMemorasNGET[$i] as $servicio)
                    <tr>
                        ...
                        <td>
                            ...
                            @foreach($nombresParticipantesPorRevistaNacional[$servicio->id] ?? [] as $participante)
                            ...
                            @if ($servicio instanceof \App\Models\Memoria)
                                @foreach($nombresParticipantesPorMemoriasNacional[$servicio->id] ?? [] as $participanteMemoria)
