...
$('.button').click(function(){
  ...
  $(document).on("click", "#btnedit",function(){
    ...
    var tiporevista = $(this).data('tiporevista');
    var titulo = $(this).data('titulo');
    var tipoarticulo = $(this).data('tipoarticulo');
    var nombrerevista = $(this).data('nombrerevista');
    var numerorevista = $(this).data('numerorevista');
    ...
    $('#tiporevistaedit').val(tiporevista);
    $('#tituloarticuloedit').val(titulo);
    $('#tipoarticuloedit').val(tipoarticulo);
    $('#nombrerevistaedit').val(nombrerevista);
    $('#numerorevistaedit').val(numerorevista);
...
$(document).ready(function() {
  ...
  $(document).on("click", "#btnviz",function(){
    ...
    $('#tipoarticuloviz').text(tipoarticulo);
    $('#nombrerevistaviz').text(nombrerevista);
    $('#numerorevistaviz').text(numerorevista);
