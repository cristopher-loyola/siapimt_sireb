...
<body>
    ...
    <div>
        <center><h2>Cantidad de Cursos impartidos y Tesis Dirigidas por Bimestre</h2></center>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var datosGrafica = {!! json_encode($serviciosTesisCursosGET) !!};
            ...
            var proyectosChart = new Chart(proyectosCanvas, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Cantidad de Tesis y Cursos recividos',
