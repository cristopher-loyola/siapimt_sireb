...
<p>Buen día, se le notifica que el protocolo del proyecto {{ $details['clave'] }} ha sido revisado, pero se requiere <br>
que realice modificaciones, atendiendo las observaciones realizadas.</p>
<p>Comentarios generales:<br>
{{ $details['obsgnrl'] }}</p>
<p>Atentamente,<br>
{{ $details['mando']}}<br>
{{ $details['area'] }}</p>
