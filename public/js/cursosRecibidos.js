...
$('.button').click(function(){
  ...
  $(document).on("click", "#btnedit",function(){
    ...
    var duracioncurso = $(this).data('duracioncurso');
    var organizadora = $(this).data('organizadora');
    ...
    $('#nombrecursoedit').val(nombrecurso);
    $('#fechainicioedit').val(fechainicio);
    $('#fechafinedit').val(fechafin);
    $('#duracionedit').val(duracioncurso);
    $('#D_pertenecienteedit').val(organizadora);
    $('#lugaredit').val(lugar);
    $('#nombrepersonaedit').val(nombrepersona);
...
$(document).ready(function() {
  ...
  $(document).on("click", "#btnviz",function(){
    ...
    // Llenar los campos del formulario modal con los datos de la fila
    $('#nombrecursoviz').text(nombrecurso);
    $('#fechainicioviz').text(fechainicio);
    $('#fechafinviz').text(fechafin);
    $('#duracioncursoviz').text(duracioncurso);
    $('#organizadoraviz').text(organizadora);
    $('#lugarviz').text(lugar);
    $('#nombrepersonaviz').text(nombrepersona);
