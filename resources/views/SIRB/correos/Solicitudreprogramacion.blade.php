...
<br>
<br>
<p>Buen día. Solicito por este medio la reprogramación del Proyecto {{ $details['clave'] }}
, conforme al Plan de control de procesos RA-002 Investigación de iniciativa
interna, donde se indica que, en caso de presentarse un retraso en el desarrollo del
proyecto de investigación mayor a un mes, independientemente de la causa que lo
generó, el responsable del proyecto debe notificar por escrito a su Coordinador/Jefe de
División. Por lo anterior, expongo la siguiente justificación:</p>
<p>{{ $details['just']}}</p>
<br>
