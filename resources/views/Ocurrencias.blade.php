...
@section('contenido')
    ...
    <title>Riesgos</title>
        <br>
        <div>
        <h2 class="text-center" id="title"> Catálogo / Ocurrencias </h2>
        </div>
        <br>
        <a href="addocurrencia">
        ...
        <br>
          <div> 
            <table class="table table-dark table-hover">
              <thead>
                <tr>
                  <th scope="col" class="">Nombre de la ocurrencia</th>
              ...
              <tbody>
                ...
                <tr>
                  <td>{{$cur->nombre_ocurrencia}}</td>
                  <td><input type="checkbox" data-offstyle="danger"
                    class="toggle-class" data-id="{{$cur->id}}"
                    ...
                    {{$cur->status == true ? 'checked' : ''}}>
                  </td>
                  <td>
                    <form action="{{route('upocurrencia', $cur->id)}}" method="get">
                ...
                $(function(){
                   $('.toggle-class').on('change', function(){
                        ...
                        $.ajax({
                            ...
                            type: 'GET',
                            dataType: 'json',
                            url: '{{ route('changestatuocurrencia') }}',
