...
<title>Modo de transporte</title>
      ...
      <br>
      <div>
      <h2 class="text-center" id="title"> Catálogo / Modo de Transporte </h2>
      </div>
      <br>
        <a href="addtrans">
