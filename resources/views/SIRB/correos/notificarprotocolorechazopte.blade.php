...
<p>Buen día, se le notifica que la Propuesta Técnico-Económica del proyecto {{ $details['clave'] }} ha sido revisado, <br>
pero se ha rechazado el proyecto, atendiendo a este mensaje cambiar el estado del proyecto a "no aceptado".</p>
<p>Motivo:<br>
{{ $details['obsgnrl'] }}</p>
<p>Atentamente,<br>
{{ $details['mando']}}<br>
