...
$('.button').click(function(){
  ...
  $(document).on("click", "#btneditC",function(){
    ...
    var nombrecomite = $(this).data('nombrecomite');
    var nombre = $(this).data('nombre');
    var cargocomite = $(this).data('cargo');
    var dependenciacomite = $(this).data('dependencia');
    ...
    $('#fechaedit').val(fecha);
    $('#nombrecomiteedit').val(nombrecomite);
    $('#nombreedit').val(nombre);
    $('#cargoedit').val(cargocomite);
    $('#dependenciaedit').val(dependenciacomite);
    $('#adesarrolladasedit').val(adesarrolladas);
  ...
  cancelButton.addEventListener('click', function () {
    ...
    // javascript para el modal de configurar
    $(document).on("click", "#btnconfigci", function(){
      console.log('Código JavaScript ejecutado.');
  
      // Obtener la acción del formulario (a través del atributo de datos)
      var formActionElim1 = $(this).data('idconfig');
  
      // Establecer la acción del formulario para el envío del formulario
      $('#configForm').attr('action', formActionElim1);
  
      $('#modal-container-configurar').removeAttr('class').addClass('five-configurar');
      $('body').addClass('modal-active');
    });
    // Resto de tu código para cerrar el modal y recargar la página al hacer clic en "Cancelar"
    var cancelButton = document.getElementById('cancel-button-configurar');
  
    cancelButton.addEventListener('click', function () {
      var modalContainer = document.getElementById('modal-container-configurar');
      modalContainer.style.display = 'none';
      window.location.reload();
    });
  
  
      // javascript para el modal de configurar2
    $(document).on("click", "#btnconfigir", function(){
      console.log('Código JavaScript ejecutado.');
  
      // Obtener la acción del formulario (a través del atributo de datos)
      var formActionElim2 = $(this).data('idconfig');
  
      // Establecer la acción del formulario para el envío del formulario
      $('#configForm2').attr('action', formActionElim2);
  
      $('#modal-container-configurar2').removeAttr('class').addClass('five-configurar');
      $('body').addClass('modal-active');
    });
    // Resto de tu código para cerrar el modal y recargar la página al hacer clic en "Cancelar"
    var cancelButton = document.getElementById('cancel-button-configurar2');
  
    cancelButton.addEventListener('click', function () {
      var modalContainer = document.getElementById('modal-container-configurar2');
      modalContainer.style.display = 'none';
      window.location.reload();
    });
  ...
  $(document).on("click", "#btnviz",function(){
    ...
    $('#nombrecomiteviz').text(nombrecomite);
    $('#cargoviz').text(cargocomite);
    $('#dependenciaviz').text(dependenciacomite);
    $('#adesarrolladasviz').text(adesarrolladas);
...
//CREAR
    ...
    var selectElement = document.getElementById('dependencia_V');
