...
<p>Buen día {{ $details['participante']->Nombre }}, se le notifica que {{ $details['servicio']->username }} lo ha excluido en el Sistema de Reportes Bimestrales, como participante de:</p>
