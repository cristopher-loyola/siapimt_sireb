...
$(document).on("click", "#btnedit",function(){
  ...
  var cargoActual = $(this).data('cargo');
  var productoFinal = $(this).data('producto');
  var tiempoDedicado = $(this).data('tiempo');
  ...
  $('#fechaedit').val(fecha);
  $('#tipo_solicitudedits').val(tipoSolicitud);
  $('#D_pertenecienteedit').val(DPerteneciente);
  $('#cargo_actualedit').val(cargoActual);
  $('#producto_finaledit').val(productoFinal);
  $('#tiempo_dedicadoedit').val(tiempoDedicado);
  $('#descripcionedit').val(descripcion);
  $('#titulosoledit').val(titulo);
  $('#encargadoservicioedit').val(encargado);
...
$(document).on("click", "#btnviz",function(){
  ...
  $('#cargoviz').text(cargoActual);
  $('#productoviz').text(productoFinal);
  $('#tiempoviz').text(tiempoDedicado);
  $('#descripviz').text(descripcion);
  $('#nombreviz').text(nombre);
  $('#titulosolviz').text(titulo);
