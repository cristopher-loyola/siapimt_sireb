...
{{-- Barra de navegacion lateral principio --}}
        <div class="sidebar">
            ...
            <ul class="nav_list">
                <li><hr color="white"><span class="links_name_alt">Proyectos </span></li>
                <li>
                    <a href="dashboard">
        ...
        {{-- Drop Para los menus de catalogos Inicio --}}
                <li>
                    <a id="icon" data-bs-toggle="dropdown">
                        <i class='bx bxs-food-menu'></i>
                        <span class="links_name_alt">Catálogos</span>
                    </a>
                    ...
                    <ul class="dropdown-menu" id="menu">
                        ...
                        <li>
                            <a href="puesto">
                                ...
                                <span class="links_name">Puestos</span>
                            </a>
        ...
        {{-- Drop Para los menus de catalogos Fin --}}
                ...
                <li>
                    ...
                    <span class="tooltip">Admin. Usuarios</span>
                </li>
                <li>
                    <a href="adpindex">
                        <i class='bx bx-folder'></i>
                        <span class="links_name">Admin. Proyectos</span>
                    </a>
                    <span class="tooltip">Admin. Proyectos</span>
                </li>

                <li>
                    <a href="difusionD">
                        <i class="bi bi-database-up"></i>
                        <span class="links_name">Actualizar BD</span>
                    </a>
                    <span class="tooltip">Actualizar BD</span>
                </li>

                <li><hr color="white"><span class="links_name_alt">Administrativos</span></li>

                <li>
                    <a href="Financiero">
                        <i class='bx bxs-wallet'></i>
                        <span class="links_name">Financiero</span>
                    </a>
                    <span class="tooltip">Financiero</span>
                </li>
                <li>
                    <a href="partidas">
...
{{-- Fin Barra de navegacion lateral principio --}}
        ...
        <nav class="navbar navbar-light bg-transparent justify-content-between">
            ...
            <div>
                ...
                <label id="sesion">Sesión de Admin</label>

            </div>
        </nav>
        <div class="container w-75 bg-Transparent mt-5 roundedshadow p-3 mb-5 bg-body rounded font-weight-ligth col-xs-12 col-sm-6 col-md-8" >
                {{-- <div>
                    <label id="userid"></label>
                    <label id="sesion"></label>
                    </div>
                    <div>
                        <img src="img/Logo_blanco.png" alt="65" width="100"><label id="titulo">Instituto Mexicano del Transporte</label>
                        <label id="subtitulo"> SIAPIMT </label>
                        <label id="dia"><script type="text/javascript">
                        var d = new Date();
                        var mm=new Date();
                        var m2 = mm.getMonth() + 1;
