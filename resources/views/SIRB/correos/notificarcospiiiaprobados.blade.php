...
<p>Buen día, se le notifica que el protocolo del proyecto {{ $details['clave'] }} ha sido aprobado por el COSPIII,<br>
para la firma del protocolo.</p>
@if (  $details['obsprotocolo'] != "")
<p>Se Debes atender las observaciones señaladas antes de entregarse: <br>
{{ $details['obsprotocolo'] }}
</p>    
@endif
