...
$('.button').click(function(){
  ...
  $(document).on("click", "#btnedit", function () {
    ...
    var tipoSolicitud = $(this).data('tipo');
    ...
    $('#lugar_reunionedit').val(lugar);
    $('#D_pertenecienteedit').val(dependencia);
    $('#nombre_personaedit').val(nombre);
    $('#usuarios_seleccionadosedit').val(usuariosseleccionados);
    $('#usuarios_seleccionadoseditMail').val(usuariosseleccionados);
    // Mostrar u ocultar el campo adicional según el valor del select
    if (tipoSolicitud !== "Promoción de servicios de asesoría e investigación en transporte" &&
        tipoSolicitud !== "Reunión de trabajo con el cliente") {
        $('#campo_otroedit').css('display', 'block');
        $('#otro_tipoedit').val(tipoSolicitud);
        $('#tipo_reunionedit').val('Otroedit');
    } else {
        $('#campo_otroedit').css('display', 'none');
        $('#otro_tipoedit').val(''); // Limpiar el campo de texto
        $('#tipo_reunionedit').val(tipoSolicitud);
    }
...
$(document).ready(function() {
  ...
  $(document).on("click", "#btnelimR",function(){
    ...
    // Obtener la acción del formulario (a través del atributo de datos)
    var formActionElim = $(this).data('idelimr');
  ...
  $(document).on("click", "#btnviz",function(){
    ...
    var fecha = $(this).data('fecha');
    var tipoSolicitud = $(this).data('tipo');
    var DPerteneciente = $(this).data('dependencia');
    var lugar = $(this).data('lugar');
    var descripcion = $(this).data('descripcion');
    ...
    // Llenar los campos del formulario modal con los datos de la fila
    $('#fechaviz').text(fecha);
    $('#tipoviz').text(tipoSolicitud);
    $('#dependenciaviz').text(DPerteneciente);
    $('#lugarviz').text(lugar);
    $('#descripviz').text(descripcion);
    $('#nombreviz').text(nombre);
...
// Obtener el select y el campo de entrada adicional
const selectTipoReunion = document.getElementById("tipo_reunion");
const campoOtro = document.getElementById("campo_otro");

// Escuchar el evento de cambio en el select
selectTipoReunion.addEventListener("change", function () {
  if (selectTipoReunion.value === "Otro") {
    // Mostrar el campo de entrada adicional si se selecciona "Otro"
    campoOtro.style.display = "block";
  } else {
    // Ocultar el campo de entrada adicional en caso contrario
...
// Obtener el select y el campo de entrada adicional
const selectTipoReunionedit = document.getElementById("tipo_reunionedit");
const campoOtroedit = document.getElementById("campo_otroedit");

// Escuchar el evento de cambio en el select
selectTipoReunionedit.addEventListener("change", function () {
  if (selectTipoReunionedit.value === "Otroedit") {
    // Mostrar el campo de entrada adicional si se selecciona "Otro"
    campoOtroedit.style.display = "block";
  } else {
    // Ocultar el campo de entrada adicional en caso contrario
    campoOtroedit.style.display = "none";
  }
});
