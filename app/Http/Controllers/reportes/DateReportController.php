...
class DateReportController extends Controller
{
    public function getReport(Request $request){
        ...
        $dateStart = $request->get('inicio');
        $dateEnd = $request->get('fin');
        try {
            $report = new GeneralReport(
                $this->getDataForReport($dateStart,$dateEnd),'reporte_por_fecha',
                'Reporte General de Proyectos', 'report_date'
            );
    ...
    public function getProjects($dateStart,$dateEnd){
        ...
        ->whereBetween('fecha_fin', [$dateStart, $dateEnd])
