...
$('.button').click(function(){
  ...
  $(document).on("click", "#btnedit",function(){
    ...
    var titulocurso = $(this).data('titulocurso');
    ...
    $('#titulodocenciaedit').val(titulocurso);
    $('#tipoedit').val(tipocurso);
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (sesionEspecial === 1) {
    ...
    habilitarFechasBimestresActualesYAnteriores2(inputFecha);
