...
<head>
    ...
    <title>Recurso Financieros</title>
    ...
    function crear(obj) {
        ...
        var array = ["Viaticos Nacionales(Investigador)","Viaticos Nacionales(Investigador)", "Gastos de camino(peajes)","Gastos de camino(combustible)"];
...
{{-- <form name="form1" method="POST" action="save.php"> --}}
    <div class="container text-center mb-4">
        <h1 class= "display-1 mt-4 text-white "> Recurso Financieros </h1>
    </div>
