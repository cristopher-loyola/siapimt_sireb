...
<body>
    ...
    <div>
        <center><h2>Cantidad de Reuniones y Solicitudes por Bimestre</h2></center>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var datosGrafica = {!! json_encode($serviciosReunionSolicitudGET) !!};
            ...
            var proyectosChart = new Chart(proyectosCanvas, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Cantidad de Reuniones y Solicitudes',
